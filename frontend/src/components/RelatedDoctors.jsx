...
const RelatedDoctors = ({ docId , speciality }) => {
  ...
  return (
    <div className="flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10">
        ...
        <p className="sm:w-1/3 text-center text-sm">Easily explore our extensive list of trusted doctors</p>
...
RelatedDoctors.propTypes = {
    docId: PropTypes.string.isRequired, // Ensures docId is a required string
    speciality: PropTypes.string.isRequired, // Ensures speciality is a required string
  };
